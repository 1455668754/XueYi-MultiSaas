...
public interface RemoteLogService {
    ...
    public R<Boolean> saveLog(@RequestBody SysOperationLogDto operationLog, @RequestHeader(SecurityConstants.FROM_SOURCE) String source);
    ...
    public R<Boolean> saveLoginInfo(@RequestBody SysLoginLogDto loginInfo, @RequestHeader(SecurityConstants.FROM_SOURCE) String source);
}