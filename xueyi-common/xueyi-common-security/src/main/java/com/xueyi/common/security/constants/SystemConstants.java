...
public interface SystemConstants {
    ...
    /** 系统 - 模块管理 - 修改状态 */
    String SYS_MODULE_EDIT_STATUS = "authority:module:editStatus";
    /** 系统 - 模块管理 - 删除 */
    ...
    /** 系统 - 菜单管理 - 修改状态 */
    String SYS_MENU_EDIT_STATUS = "authority:menu:editStatus";
    /** 系统 - 菜单管理 - 删除 */
    ...
    /** 系统 - 字典管理 - 修改状态 */
    String SYS_DICT_EDIT_STATUS = "dict:dict:editStatus";
    /** 系统 - 字典管理 - 删除 */
