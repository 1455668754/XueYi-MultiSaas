...
insert into sys_menu (id, parent_id, name, title, ancestors, path, frame_src, component, param_path, transition_name, ignore_route, is_cache, is_affix, is_disabled, frame_type, menu_type, hide_tab, hide_menu, hide_breadcrumb, hide_children, hide_path_for_children, dynamic_level, real_path, current_active_menu, perms, icon, sort, remark, is_common, is_default, module_id, tenant_id)
values (1480797756900507648, 14000000, 'SysModule', '模块管理', '0', 'module', null, 'system/authority/module/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:list', 'xy_organization', 1, '菜单:模块管理', 'Y', 'Y', 0, 0),
       (1480797756900507649, 1480797756900507648, 'SysModuleDetail', '模块详情', '0,1480797756900507648', 'detail/:id', null, 'system/authority/module/ModuleDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', 'N', 'Y', 'N', 'N', 'N', 5, null, '/authority/module', 'authority:module:single', '#', 2, '详情:模块详情', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleAdd', '模块新增', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:add', '#', 3, '按钮:模块新增', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleEdit', '模块修改', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:edit', '#', 4, '按钮:模块修改', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleEditStatus', '模块修改状态', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:editStatus', '#', 5, '按钮:模块修改状态', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleDelete', '模块删除', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:delete', '#', 6, '按钮:模块删除', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleImport', '模块导入', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:import', '#', 7, '按钮:模块导入', 'Y', 'Y', 0, 0),
       (1480797756900507650, 1480797756900507648, 'SysModuleExport', '模块导出', '0,1480797756900507648', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'authority:module:export', '#', 8, '按钮:模块导出', 'Y', 'Y', 0, 0);
