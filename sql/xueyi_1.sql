...
values (0, 0, 'd346c7dbf265416086dbe2951a7465b2', '默认菜单', '', 'default', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, null, '', 1, '目录:默认菜单', '0', 'Y', 0, 0),
       ...
       (24000000, 0, '65a261f21077447fa28db33268f5ae82', '租户管理', '0', 'tenantManager', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'xy_organization', 3, '目录:租户管理', '0', 'Y', 1, 0),
           ...
           (24020000, 24000000, '6b1f5a23273f4be2a7aeaaec16d5a972', '数据源策略管理', '0,24000000', 'strategy', null, 'tenant/tenant/strategy/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:list', 'xy_organization', 1, '菜单:数据源策略管理', '0', 'Y', 1, 0),
               (24020100, 24020000, 'bb6ecc8a720a4793bd93c6d060abd4d0', '数据源策略详情', '0,24000000,24020000', 'strategyDetail/:id', null, 'tenant/tenant/strategy/StrategyDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', '0', '1', '0', '0', '0', 5, null, 'tenant:strategy:single', null, 2, '详情:数据源策略详情', '0', 'Y', 1, 0),
               (24020200, 24020000, 'eb999cfc3b924c5d9973cfd3d24ee221', '数据源策略新增', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:add', null, 3, '按钮:数据源策略新增', '0', 'Y', 1, 0),
               (24020300, 24020000, '7063e7b32edb49769dbf4a66c69470c6', '数据源策略修改', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:edit', null, 4, '按钮:数据源策略修改', '0', 'Y', 1, 0),
               (24020400, 24020000, '303eb6f1190e4f288f6019a5197f0de6', '数据源策略修改状态', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:editStatus', null, 5, '按钮:数据源策略修改状态', '0', 'Y', 1, 0),
               (24020500, 24020000, '4866eca79112480c8791ab3b01acc15a', '数据源策略删除', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:delete', null, 6, '按钮:数据源策略删除', '0', 'Y', 1, 0),
               (24020600, 24020000, '7fc8f11b95cd497ab8b93f1d93107124', '数据源策略导入', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:import', null, 7, '按钮:数据源策略导入', '0', 'Y', 1, 0),
               (24020700, 24020000, '6fe711d2c5b648149f52e5e8a1be809a', '数据源策略导出', '0,24000000,24020000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:export', null, 8, '按钮:数据源策略导出', '0', 'Y', 1, 0),
