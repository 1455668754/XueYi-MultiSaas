...
values (0, 0, 'Default', '默认菜单', '', 'default', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'M', 'N', 'N', 'N', 'N', 'N', 1, null, null, null, '', 1, '目录:默认菜单', 'Y', 'Y', 0, 0),
       ...
       (23010200, 23010000, 'GenCodeDetail', '代码生成预览', '0,23010000', 'code/:id', null, 'gen/generate/gen/CodeDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', 'N', 'Y', 'N', 'N', 'N', 5, null, '/generate/gen', 'generate:gen:preview', 'xy_organization', 2, '详情:代码生成预览', 'Y', 'Y', 0, 0),
       ...
       (24010100, 24010000, 'TeTenantDetail', '租户详情', '0,1481927135156240384', 'TenantDetail/:id', null, 'tenant/tenant/tenant/TenantDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', 'N', 'Y', 'N', 'N', 'N', 5, null, '/tenantManager/tenant', 'tenant:tenant:single', '#', 2, '详情:租户详情', 'Y', 'Y', 1, 0),
       (24010200, 24010000, 'TeTenantAdd', '租户新增', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:add', '#', 3, '按钮:租户新增', 'Y', 'Y', 1, 0),
       (24010300, 24010000, 'TeTenantEdit', '租户修改', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:edit', '#', 4, '按钮:租户修改', 'Y', 'Y', 1, 0),
       (24010400, 24010000, 'TeTenantEditStatus', '租户修改状态', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:editStatus', '#', 5, '按钮:租户修改状态', 'Y', 'Y', 1, 0),
       (24010500, 24010000, 'TeTenantDelete', '租户删除', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:delete', '#', 6, '按钮:租户删除', 'Y', 'Y', 1, 0),
       (24010600, 24010000, 'TeTenantImport', '租户导入', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:import', '#', 7, '按钮:租户导入', 'Y', 'Y', 1, 0),
       (24010700, 24010000, 'TeTenantExport', '租户导出', '0,1481927135156240384', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:tenant:export', '#', 8, '按钮:租户导出', 'Y', 'Y', 1, 0),
       ...
       (24020100, 24020000, 'TeStrategyDetail', '数据源策略详情', '0,1481913481614589952', 'StrategyDetail/:id', null, 'tenant/tenant/strategy/StrategyDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', 'N', 'Y', 'N', 'N', 'N', 5, null, '/tenantManager/strategy', 'tenant:strategy:single', '#', 2, '详情:数据源策略详情', 'Y', 'Y', 1, 0),
       (24020200, 24020000, 'TeStrategyAdd', '数据源策略新增', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:add', '#', 3, '按钮:数据源策略新增', 'Y', 'Y', 1, 0),
       (24020300, 24020000, 'TeStrategyEdit', '数据源策略修改', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:edit', '#', 4, '按钮:数据源策略修改', 'Y', 'Y', 1, 0),
       (24020400, 24020000, 'TeStrategyEditStatus', '数据源策略修改状态', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:editStatus', '#', 5, '按钮:数据源策略修改状态', 'Y', 'Y', 1, 0),
       (24020500, 24020000, 'TeStrategyDelete', '数据源策略删除', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:delete', '#', 6, '按钮:数据源策略删除', 'Y', 'Y', 1, 0),
       (24020600, 24020000, 'TeStrategyImport', '数据源策略导入', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:import', '#', 7, '按钮:数据源策略导入', 'Y', 'Y', 1, 0),
       (24020700, 24020000, 'TeStrategyExport', '数据源策略导出', '0,1481913481614589952', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:strategy:export', '#', 8, '按钮:数据源策略导出', 'Y', 'Y', 1, 0),
       ...
       (24030100, 24030000, 'TeSourceDetail', '数据源详情', '0,1481913478489833472', 'SourceDetail/:id', null, 'tenant/source/source/SourceDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', 'N', 'Y', 'N', 'N', 'N', 5, null, '/tenantManager/source', 'tenant:source:single', '#', 2, '详情:数据源详情', 'Y', 'Y', 1, 0),
       (24030200, 24030000, 'TeSourceAdd', '数据源新增', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:add', '#', 3, '按钮:数据源新增', 'Y', 'Y', 1, 0),
       (24030300, 24030000, 'TeSourceEdit', '数据源修改', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:edit', '#', 4, '按钮:数据源修改', 'Y', 'Y', 1, 0),
       (24030400, 24030000, 'TeSourceEditStatus', '数据源修改状态', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:editStatus', '#', 5, '按钮:数据源修改状态', 'Y', 'Y', 1, 0),
       (24030500, 24030000, 'TeSourceDelete', '数据源删除', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:delete', '#', 6, '按钮:数据源删除', 'Y', 'Y', 1, 0),
       (24030600, 24030000, 'TeSourceImport', '数据源导入', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:import', '#', 7, '按钮:数据源导入', 'Y', 'Y', 1, 0),
       (24030700, 24030000, 'TeSourceExport', '数据源导出', '0,1481913478489833472', '', null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', 'N', 'N', 'N', 'N', 'N', 1, null, null, 'tenant:source:export', '#', 8, '按钮:数据源导出', 'Y', 'Y', 1, 0);
