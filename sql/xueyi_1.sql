...
values (13000000, 0, '4be0456e05a7422d9f1c82fb7bf19377', '组织管理', 1, '0', 'organize', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:apartment-outlined', 1, '目录:组织管理', '0', 'Y', 1, 0),
       ...
       (15000000, 0, 'de6e93785ba944e1bde5538e92bd7b91', '公告管理', 1, '0', 'notice', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:schedule-outlined', 3, '目录:公告管理', '0', 'Y', 1, 0),
           (15010000, 15000000, 'b7214522d55c4f1ebd381859dc6774bb', '通知公告', 2, '0,15000000', 'notice', null, 'system/notice/notice/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', '0', '0', '0', '0', '0', 1, null, 'system:notice:list', 'ant-design:notification-outlined', 1, '菜单:通知公告管理', '0', 'Y', 1, 0),
               ...
               (15010400, 15010000, '010e949049864492b046883b8571063d', '通知公告删除', 3, '0,15000000,15010000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'system:notice:delete', null, 4, '按钮:通知公告删除', '0', 'Y', 1, 0),
       ...
       (21000000, 0, '65a261f21077447fa28db33268f5ae82', '租户管理', 1, '0', 'tenant', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:bank-outlined', 2, '目录:租户管理', '0', 'Y', 2, 0),
           ...
           (21020000, 21000000, '6b1f5a23273f4be2a7aeaaec16d5a972', '源策略管理', 2, '0,21000000', 'strategy', null, 'tenant/source/strategy/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', '0', '0', '0', '0', '0', 1, null, 'tenant:strategy:list', 'ant-design:code-sandbox-outlined', 2, '菜单:数据源策略管理', '0', 'Y', 2, 0),
               (21020100, 21020000, 'bb6ecc8a720a4793bd93c6d060abd4d0', '源策略详情', 3, '0,21000000,21020000', 'strategyDetail/:id', null, 'tenant/source/strategy/StrategyDetail', null, null, 'N', 'Y', 'N', 'N', '0', 'X', '0', '1', '0', '0', '0', 5, null, 'tenant:strategy:single', null, 1, '详情:数据源策略详情', '0', 'Y', 2, 0),
       ...
       (22000000, 0, '0d7114083f3e4c169e29bb7c4c2394d1', '权限管理', 1, '0', 'authority', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:safety-certificate-outlined', 3, '目录:权限管理', '0', 'Y', 2, 0),
           ...
           (22030000, 22000000, '1915bdb53937486a82d9ce9d380d41b1', '权限组管理', 2, '0,22000000', 'authGroup', null, 'system/authority/authGroup/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', '0', '0', '0', '0', '0', 1, null, 'authority:authGroup:list', 'ant-design:property-safety-outlined', 1, '菜单:权限组管理', '0', 'Y', 2, 0),
...
values (1000101, 1, '男', '0', 'sys_user_sex', '', '', 'Y', '性别男', 0),
       (1000102, 2, '女', '1', 'sys_user_sex', '', '', 'N', '性别女', 0),
       (1000103, 3, '未知', '2', 'sys_user_sex', '', '', 'N', '性别未知', 0),
       ...
       (1000401, 1, '正常', '0', 'sys_normal_disable', '', 'blue', 'Y', '正常状态', 0),
       (1000402, 2, '停用', '1', 'sys_normal_disable', '', 'red', 'N', '停用状态', 0),
       (1000501, 1, '正常', '0', 'sys_job_status', '', 'blue', 'Y', '正常状态', 0),
       (1000502, 2, '暂停', '1', 'sys_job_status', '', 'red', 'N', '停用状态', 0),
       (1000601, 1, '默认', '0', 'sys_job_policy', '', 'blue', 'N', '任务策略：默认', 0),
       (1000602, 2, '立即执行', '1', 'sys_job_policy', '', 'green', 'N', '任务策略：立即执行', 0),
       (1000603, 3, '执行一次', '2', 'sys_job_policy', '', 'cyan', 'N', '任务策略：执行一次', 0),
       (1000604, 4, '放弃执行', '3', 'sys_job_policy', '', 'purple', 'N', '任务策略：放弃执行', 0),
       (1000701, 1, '允许', '0', 'sys_job_concurrent', '', 'blue', 'N', '任务并发：允许', 0),
       (1000702, 2, '禁止', '1', 'sys_job_concurrent', '', 'red', 'N', '任务并发：禁止', 0),
       (1000801, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '默认分组', 0),
       (1000802, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 'N', '系统分组', 0),
       (1000901, 1, '是', 'Y', 'sys_yes_no', '', 'blue', 'Y', '常规-是否：是', 0),
       (1000902, 2, '否', 'N', 'sys_yes_no', '', 'red', 'N', '常规-是否：否', 0),
       (1001001, 1, '通知', '0', 'sys_notice_type', '', 'blue', 'Y', '通知', 0),
       (1001002, 2, '公告', '1', 'sys_notice_type', '', 'green', 'N', '公告', 0),
       (1001101, 1, '待发送', '0', 'sys_notice_status', '', 'blue', 'Y', '待发送', 0),
       (1001102, 2, '已发送', '1', 'sys_notice_status', '', 'green', 'N', '已发送', 0),
       (1001103, 3, '已关闭', '2', 'sys_notice_status', '', 'cyan', 'N', '已关闭', 0),
       (1001104, 4, '发送失败', '3', 'sys_notice_status', '', 'orange', 'N', '发送失败', 0),
       (1001105, 5, '发送异常', '4', 'sys_notice_status', '', 'red', 'N', '发送异常', 0),
       (1001201, 1, '其它', '00', 'sys_operate_business', '', 'orange', 'N', '操作类型：其它', 0),
       (1001202, 2, '新增', '01', 'sys_operate_business', '', 'blue', 'N', '操作类型：新增', 0),
       (1001203, 3, '强制新增', '02', 'sys_operate_business', '', 'red', 'N', '操作类型：强制新增', 0),
       (1001204, 4, '修改', '03', 'sys_operate_business', '', 'green', 'N', '操作类型：修改', 0),
       (1001205, 5, '强制修改', '04', 'sys_operate_business', '', 'red', 'N', '操作类型：强制修改', 0),
       (1001206, 6, '权限控制', '05', 'sys_operate_business', '', 'purple', 'N', '操作类型：权限控制', 0),
       (1001207, 7, '修改状态', '06', 'sys_operate_business', '', 'purple', 'N', '操作类型：修改状态', 0),
       (1001208, 8, '强制修改状态', '07', 'sys_operate_business', '', 'red', 'N', '操作类型：强制修改状态', 0),
       (1001209, 9, '删除', '08', 'sys_operate_business', '', 'orange', 'N', '操作类型：删除', 0),
       (1001210, 10, '强制删除', '09', 'sys_operate_business', '', 'red', 'N', '操作类型：强制删除', 0),
       (1001211, 11, '授权', '10', 'sys_operate_business', '', 'orange', 'N', '操作类型：授权', 0),
       (1001212, 12, '导出', '11', 'sys_operate_business', '', 'pink', 'N', '操作类型：导出', 0),
       (1001213, 13, '导入', '12', 'sys_operate_business', '', 'cyan', 'N', '操作类型：导入', 0),
       (1001214, 14, '强退', '13', 'sys_operate_business', '', 'orange', 'N', '操作类型：强退', 0),
       (1001215, 15, '生成代码', '14', 'sys_operate_business', '', 'orange', 'N', '操作类型：生成代码', 0),
       (1001216, 16, '清空数据', '15', 'sys_operate_business', '', 'orange', 'N', '操作类型：清空数据', 0),
       (1001217, 17, '更新缓存', '16', 'sys_operate_business', '', 'orange', 'N', '操作类型：更新缓存', 0),
       (1001301, 1, '其它', '00', 'sys_operate_type', '', 'green', 'N', '操作类别：其它', 0),
       (1001302, 2, '后台用户', '01', 'sys_operate_type', '', 'blue', 'N', '操作类别：后台用户', 0),
       (1001303, 3, '手机端用户', '02', 'sys_operate_type', '', 'red', 'N', '操作类别：手机端用户', 0),
       (1001401, 1, '正常', '0', 'sys_operate_status', '', 'green', 'N', '操作状态：正常', 0),
       (1001402, 2, '异常', '1', 'sys_operate_status', '', 'red', 'N', '操作状态：异常', 0),
       (1001501, 1, '成功', '0', 'sys_message_status', '', 'blue', 'N', '状态：成功', 0),
       (1001502, 2, '失败', '1', 'sys_message_status', '', 'red', 'N', '状态：失败', 0),
       (1001601, 1, 'none', '', 'sys_dict_color', '', '', 'N', '字典颜色：none', 0),
       (1001602, 2, 'red', 'red', 'sys_dict_color', '', 'red', 'N', '字典颜色：red', 0),
       (1001603, 3, 'pink', 'pink', 'sys_dict_color', '', 'pink', 'N', '字典颜色：pink', 0),
       (1001604, 4, 'orange', 'orange', 'sys_dict_color', '', 'orange', 'N', '字典颜色：orange', 0),
       (1001605, 5, 'green', 'green', 'sys_dict_color', '', 'green', 'N', '字典颜色：green', 0),
       (1001606, 6, 'blue', 'blue', 'sys_dict_color', '', 'blue', 'N', '字典颜色：blue', 0),
       (1001607, 7, 'purple', 'purple', 'sys_dict_color', '', 'purple', 'N', '字典颜色：purple', 0),
       (1001608, 8, 'cyan', 'cyan', 'sys_dict_color', '', 'cyan', 'N', '字典颜色：cyan', 0),
       (1001701, 1, '授权码模式', 'authorization_code', 'sys_grant_type', '', '', 'N', '授权码模式', 0),
       (1001702, 2, '密码模式', 'password', 'sys_grant_type', '', '', 'N', '密码模式', 0),
       (1001703, 3, '客户端模式', 'client_credentials', 'sys_grant_type', '', '', 'N', '客户端模式', 0),
       (1001704, 4, '简化模式', 'implicit', 'sys_grant_type', '', '', 'N', '简化模式', 0),
       (1001705, 5, '刷新模式', 'refresh_token', 'sys_grant_type', '', '', 'N', '刷新模式', 0),
       (1001801, 1, '常规', '0', 'auth_frame_type', '', 'pink', 'Y', '权限-页面类型：常规', 0),
       (1001802, 2, '内嵌', '1', 'auth_frame_type', '', 'cyan', 'N', '权限-页面类型：内嵌', 0),
       (1001803, 3, '外链', '2', 'auth_frame_type', '', 'green', 'N', '权限-页面类型：外链', 0),
       (1001901, 1, '目录', 'M', 'auth_menu_type', '', 'pink', 'Y', '权限-菜单类型：目录', 0),
       (1001902, 2, '菜单', 'C', 'auth_menu_type', '', 'cyan', 'N', '权限-菜单类型：菜单', 0),
       (1001903, 3, '详情', 'X', 'auth_menu_type', '', 'purple', 'N', '权限-菜单类型：详情', 0),
       (1001904, 4, '按钮', 'F', 'auth_menu_type', '', 'green', 'N', '权限-菜单类型：按钮', 0),
       (1002001, 1, '全部数据权限', '1', 'auth_data_scope', '', '', 'Y', '权限-数据范围：全部数据权限', 0),
       (1002002, 2, '自定数据权限', '2', 'auth_data_scope', '', '', 'N', '权限-数据范围：自定数据权限', 0),
       (1002003, 3, '本部门数据权限', '3', 'auth_data_scope', '', '', 'N', '权限-数据范围：本部门数据权限', 0),
       (1002004, 4, '本部门及以下数据权限', '4', 'auth_data_scope', '', '', 'N', '权限-数据范围：本部门及以下数据权限', 0),
       (1002005, 5, '本岗位数据权限', '5', 'auth_data_scope', '', '', 'N', '权限-数据范围：本岗位数据权限', 0),
       (1002006, 6, '仅本人数据权限', '6', 'auth_data_scope', '', '', 'N', '权限-数据范围：仅本人数据权限', 0),
       (1002101, 1, '读&写', '0', 'sys_source_type', '', 'blue', 'Y', '读&写', 0),
       (1002102, 2, '只读', '1', 'sys_source_type', '', 'green', 'N', '只读', 0),
       (1002103, 3, '只写', '2', 'sys_source_type', '', 'red', 'N', '只写', 0),
       (1002201, 1, '子数据源', '0', 'sys_database_type', '', 'green', 'Y', '子数据源', 0),
       (1002202, 2, '主数据源', '1', 'sys_database_type', '', 'red', 'N', '主数据源', 0),
       (1002301, 1, '自动配置', '0', 'te_configuration_type', '', '', 'N', '配置类型：自动配置', 0),
       (1002302, 2, '手动配置', '1', 'te_configuration_type', '', '', 'N', '配置类型：手动配置', 0),
       ...
       (1003001, 1, '默认', '0', 'sys_dict_data_type', '', 'blue', 'N', '字典管理-数据类型：默认', 0),
       (1003002, 2, '只增', '1', 'sys_dict_data_type', '', 'green', 'N', '字典管理-数据类型：只增', 0),
       (1003003, 3, '只减', '2', 'sys_dict_data_type', '', 'cyan', 'N', '字典管理-数据类型：只减', 0),
       (1003004, 4, '只读', '3', 'sys_dict_data_type', '', 'purple', 'N', '字典管理-数据类型：只读', 0),
       (1003101, 1, '租户', '0', 'sys_dict_cache_type', '', 'purple', 'N', '字典管理-缓存类型：租户', 0),
